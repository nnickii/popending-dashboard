...
try {
    ...
    $sql = "SELECT * FROM po_pending WHERE 1=1"; // Default condition to allow flexibility
...
form {
    ...
    align-items: center;
    margin-bottom: 0;
    flex-wrap: nowrap; /* แก้ไข: ไม่แยกบรรทัด */
}
    ...
    <div class="container-fluid px-4">
        <a class="nav-link" href="index.php" style="text-decoration: none;">
            <h2 class="text-center" style="color:rgb(255, 255, 255); text-align: center;">
                PO Group: <?php echo htmlspecialchars($po_group); ?>
            </h2>
        </a>
