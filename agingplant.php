...
if ($aging) {
    switch ($aging) {
        ...
        case '>360':
            ...
            break;
        default:
            echo "<p style='color: red;'>Invalid aging range.</p>";
            exit;
    }
}
...
<body>
    <div class="container-fluid px-4">
        <a class="nav-link" href="index.php" style="text-decoration: none; color: #495057;">
            <h2 class="text-center" style="color:rgb(255, 255, 255); text-align: center;">Aging: <?php echo htmlspecialchars($aging); ?> Days</h2>
        </a>
